...
layout = dbc.Container([
    ...
    html.Div([
        html.Div([dbc.CardHeader(Lottie(options=options, width="55%", height="55%", url=B))], className="three columns",style={'height': '50px', 'width': '200px','background-color': 'black'}),
        html.Div([dbc.CardHeader(Lottie(options=options, width="55%", height="55%", url=B))], className="three columns",style={'height': '50px', 'width': '200px','background-color': 'black'}),
        html.Div([dbc.CardHeader(Lottie(options=options, width="30%", height="25%", url=url_coonections))], className="three columns",style={'height': '50px', 'width': '200px','background-color': 'black'}),
        html.Br(),
    ], className="row",style={ 'width': '50%','margin': '0 auto'}),

    html.Div([
    html.Div(id='S',className="three columns",style={'height': '50px', 'width': '200px','background-color': 'white','color':'#9CDBE7','text-align':'center','vertical-align': 'middle','line-height': '50px','font-size':'20px'}),
    html.Div(id='LY', className="three columns",style={'height': '50px', 'width': '200px','background-color': 'white','color':'#9CDBE7','text-align':'center','vertical-align': 'middle','line-height': '50px','font-size':'20px'}),
    html.Div(id='rate',className="three columns",style={'height': '50px', 'width': '200px','background-color': 'white','color':'#9CDBE7','text-align':'center','vertical-align': 'middle','line-height': '50px','font-size':'20px'}),
    html.Br(),
    ],className="row",style={ 'width': '50%','margin': '0 auto'}),
    html.Br(),
    html.Br(),
