...
import json
f = open('C:/Users/Ikram/Desktop/SIG-BI/provine_ma_15_.geojson')
data = json.load(f)
...
def update_map(y, r, edlev):
    ...
    if y is None:
        ...
        fig = px.choropleth_mapbox(df1, geojson=data, color=x1,
                                   locations="province", featureidkey="properties.Nom_Provin",
